<%@ Page Title="You Cart" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cart.aspx.cs" Inherits="BioProduk_Vesrion1.cart" %>
    			...
    			<div class="col-md-12 ftco-animate">
    				<div class="cart-list">
	    				<table class="table">
						    ...
						    <tbody runat="server" id="tblTbody"> 
						        ...
						        <td class="product-name">
						        	<h3>Green Peas</h3>
						        	<p>Organic Green Split Peas. Fiber & Protein rich, Raw, Non-GMO, Vegan and fresh.</p>
						        </td>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="product-name">
						        	<h3>Strawberry</h3>
						        	<p>Organic strawberries grown raw, vegan ,fresh fruit. </p>
						        </td>
    		...
    		<div class="row justify-content-end">
    			...
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
    					...
    					<p class="d-flex">
    						<span>Subtotal</span>
    						<span id="subtoal" runat="server">$56.90</span>
    					</p>
    					<p class="d-flex">
    						<span>Delivery</span>
    					...
    					<p class="d-flex total-price">
    						<span>Total</span>
    						<span id="total" runat="server">$61.90</span>
    					</p>
    				</div>
